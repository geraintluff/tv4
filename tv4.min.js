...
"").replace(/\/(\.(\/|$))+/g,"/").replace(/\/\.\.$/,"/../").replace(/\/?[^\/]*/g,function(a){"/.."===a?e.pop():e.push(a)});d=e.join("").replace(/^\//,"/"===d.charAt(0)?"/":"");b=b+d+(c.protocol||c.authority||c.pathname?c.search:c.search||a.search)+c.hash}return b}function l(a,c){void 0==c?c=a.id:void 0!=a.id&&(c=m(c,a.id),a.id=c);if("object"==typeof a)if(Array.isArray(a))for(var b=0;b<a.length;b++)l(a[b],c);else if(void 0!=a.$ref)a.$ref=m(c,a.$ref);else for(b in a)"enum"!=b&&l(a[b],c)}function f(a,
c,b,d){this.message=a;this.dataPath=c?c:"";this.schemaPath=b?b:"";this.subErrors=d?d:null}f.prototype={prefixWith:function(a,c){null!=a&&(a=a.replace("~","~0").replace("/","~1"),this.dataPath="/"+a+this.dataPath);null!=c&&(c=c.replace("~","~0").replace("/","~1"),this.schemaPath="/"+c+this.schemaPath);if(null!=this.subErrors)for(var b=0;b<this.subErrors.length;b++)this.subErrors[b].prefixWith(a,c);return this}};p.tv4={schemas:{},validate:function(a,c){"string"==typeof c&&(c={$ref:c});this.missing=
[];this.addSchema("",c);var b=h(a,c);delete this.schemas[""];this.error=b;return null==b?!0:!1},addSchema:function(a,c){l(c,a);this.schemas[a]=c},getSchema:function(a){if(void 0!=this.schemas[a])return a=this.schemas[a];var c=a,b="";-1!=a.indexOf("#")&&(b=a.substring(a.indexOf("#")+1),c=a.substring(0,a.indexOf("#")));if(void 0!=this.schemas[c]){a=this.schemas[c];for(var b=decodeURIComponent(b).split("/").slice(1),d=0;d<b.length;d++){var e=b[d].replace("~1","/").replace("~0","~");if(void 0==a[e]){a=
void 0;break}a=a[e]}if(void 0!=a)return a}void 0==this.missing[c]&&(this.missing.push(c),this.missing[c]=c)},missing:[],error:null,normSchema:l,resolveUrl:m}})(this);